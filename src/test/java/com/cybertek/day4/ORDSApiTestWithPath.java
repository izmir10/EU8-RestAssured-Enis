...
public class ORDSApiTestWithPath extends HRTestBase {
    ...
    public void test1(){
        ...
        System.out.println("thirdCountryID = " + thirdHref);
    ...
    public void test2(){
        ...
        List<String> namesOfITProgrammers = response.path("items.first_name");
        System.out.println("namesOfITProgrammers = " + namesOfITProgrammers);
